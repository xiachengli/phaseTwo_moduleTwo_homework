...
/******/([
        ...
        var Mditor = new mokit.Component({
            ...
            /*istanbul ignore next*/onReady: function onReady() {
                ...
                this.shortcut.bind('enter', function (event) {
                    /*istanbul ignore next*/
                    _this._ulAndQuoteAutoComplete(event);
                    /*istanbul ignore next*/
                    _this._olAutoComplete(event);
                    /*istanbul ignore next*/
                    _this._keepIndent(event);
                }, true);
                setTimeout(function () {
                    /*istanbul ignore next*/
                    _this.$emit('ready');
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = !__webpack_require__(38) && !__webpack_require__(39)(function () {
            return Object.defineProperty(__webpack_require__(40)('div'), 'a', {
                get: function () {
                    return 7;
                }
            }).a != 7;
        ...
        module.exports = new Directive({
            ...
            bind: function /*istanbul ignore next*/bind() {
                ...
                this.watcher = this.target.$watch(this.bindProp, function (value) {
                    ...
                    /*istanbul ignore next*/
                    _this.backExpr.execute(new Scope( /*istanbul ignore next*/_this.scope, {
                        _value_: value
                    }));
                });
            },
        ...
        var Toolbar = new mokit.Component({
            ...
            /*istanbul ignore next*/bindCommands: function bindCommands() {
                ...
                this.items.forEach(function (item) {
                    /*istanbul ignore next*/
                    _this.mditor.removeCommand(item.name);
                    /*istanbul ignore next*/
                    _this.mditor.addCommand(item);
                });
            },
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = new mokit.Component({
            ...
            /*istanbul ignore next*/onReady: function onReady() {
                ...
                setTimeout(function () {
                    /*istanbul ignore next*/
                    _this.textareaEmitter = new EventEmitter( /*istanbul ignore next*/_this.textarea);
                    /*istanbul ignore next*/
                    _this.stack.init({
            ...
            /*istanbul ignore next*/_bindCommands: function _bindCommands() {
                ...
                commands.forEach(function (item) {
                    /*istanbul ignore next*/
                    _this2.mditor.removeCommand(item.name);
                    /*istanbul ignore next*/
                    _this2.mditor.addCommand(item);
                });
            },
            ...
            /*istanbul ignore next*/undo: function undo() {
                ...
                if (last.range) {
                    setTimeout(function () {
                        ...
                        /*istanbul ignore next*/
                        _this5.setSelectRange(start, end);
                    });
                }
            },
            /*istanbul ignore next*/redo: function redo() {
                ...
                if (item.range) {
                    setTimeout(function () {
                        /*istanbul ignore next*/
                        _this6.setSelectRange(item.range.start, item.range.end);
                    });
                }
            },
            /*istanbul ignore next*/onPaste: function onPaste(event) {
        ...
        var Finder = new mokit.Component({
            ...
            watch: {
                /*istanbul ignore next*/findWord: function findWord() {
                    ...
                    setTimeout(function () {
                        /*istanbul ignore next*/
                        _this2.mditor.editor.activeMark(0);
                    }, 100);
                }
            },
	...
	********************************************** */
            ...
            // Plugin to make domain title show the real domain, idea by Roman Komarov
